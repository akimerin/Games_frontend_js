...
export function todoAdd(_id, name, price, studio, genre, done = false) {
  return { type: TODO_ADD, _id, name, price, studio, genre, done };
}
...
export function todoEdit(_id, name, price, studio, genre, done) {
  return { type: TODO_EDIT, _id, name, price, studio, genre, done };
}
